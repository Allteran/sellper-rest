...
import OrderConstructor from 'pages/report/OrderConstructor.vue'
import ReportRepairOrder from 'pages/report/ReportRepairOrder.vue'
...
const routes = [
    ...
    {path: '/report/order-constructor', component: OrderConstructor},
    {path: '/report/repair/', component: ReportRepairOrder},
